...
atom_info = importdata('atom_model_lower_layer_displacement_1_Convolution.mat');
atom_sim_pos  = atom_info.atomdown_sim;
atom_displace = atom_info.displacementDOWN;
atom_info = importdata('atom_model_sim_exp_matched.mat');
atom_group = atom_info.atomdowngroup;
clear atom_info
...
sample_points = [  952.9582 -5.6543e+03 0                                  % index 1 2 3 is a triangle region
                 1.0843e+03 -5.7136e+03 0                                  % index 1 3 4 is a triangle region
                 1.2012e+03 -5.6295e+03 0                                  % index 1 4 5 is a triangle region
                 1.1869e+03 -5.4861e+03 0                                  % index 1 5 6 is a triangle region
                 1.0556e+03 -5.4269e+03 0
                   938.6099 -5.5110e+03 0]';                               % the order here is important and the order is counter-clock-wise
sample_points = Rx*sample_points;
sample_points(3,:) = atom_sim_pos(3,1);

%% set parameter
center_group = 1;                                                          % set as 1 or 2, needed be explained later
atomDist = 10;  
...
center = [-6.240031738281250e+02,2.584706054687500e+03];
% scan all possibility 
a_array = 2500:50:2600;
b_array = 2800:50:2900;
phi_array = 2:0.1:4;
% Number of points
numPoints = 1000;
...
for tempa = a_array
    ...
    for tempb = b_array
        ...
        for tempphi = phi_array
            ...
            temp_error = abs(temp_Meron_number - 1);
    ...
    if temp_Meron_num < 0
        ...
        if error < 1
            ...
            if abs(temp_Meron_num+0.5) == error
                ...
                atomdown_sim = atom_sim_pos(:,temp_atom_ind);
                displacementDOWN = atom_displace(:,temp_atom_ind);
                region_index = temp_ind;
                atom_index = temp_atom_ind;
                save([pwd,'/output_data/BLG_lower_layer_meron_1.mat'],'atomdown_sim','displacementDOWN','region_index','atom_index'); 
                clear atomdown_sim displacementDOWN region_index atom_index
            ...
            elseif abs(temp_Meron_num+1) == error
                ...
                region_index = temp_ind;
                atom_index = temp_atom_ind;
                save([pwd,'/output_data/BLG_lower_layer_skyrmion_1.mat'],'atomdown_sim','displacementDOWN','region_index','atom_index');
                clear atomdown_sim displacementDOWN region_index atom_index
    ...
    if temp_Meron_num > 0
        ...
        if error < 1
            ...
            if abs(temp_Meron_num-0.5) == error
                ...
                region_index = temp_ind;
                atom_index = temp_atom_ind;
                save([pwd,'/output_data/BLG_lower_layer_anti_meron_1.mat'],'atomdown_sim','displacementDOWN','region_index','atom_index'); 
                clear atomdown_sim displacementDOWN region_index atom_index
            ...
            elseif abs(temp_Meron_num-1) == error
                ...
                region_index = temp_ind;
                atom_index = temp_atom_ind;
                save([pwd,'/output_data/BLG_lower_layer_anti_skyrmion_1.mat'],'atomdown_sim','displacementDOWN','region_index','atom_index'); 
                clear atomdown_sim displacementDOWN region_index atom_index
            end

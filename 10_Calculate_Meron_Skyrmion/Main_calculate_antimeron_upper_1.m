...
points = [1050 -1100;
          ...
          1350 -1550;
          1100 -1400]';
isInside = inpolygon(atom_sim_pos(1,:),atom_sim_pos(2,:),points(1,:),points(2,:));
atom_displace_old = atom_displace_old(:,~isInside);
atom_displace = atom_displace(:,~isInside);
atom_sim_pos = atom_sim_pos(:,~isInside);
atom_group = atom_group(:,~isInside);
clear index_group
...
center = [26.7011,2428.04575336887];
    ...
    if temp_Meron_num < 0
        ...
        if error < 1
            ...
            if abs(temp_Meron_num+0.5) == error
                ...
                save([pwd,'/output_data/BLG_upper_layer_meron_1.mat'],'atomup_sim','displacementUP','region_index','atom_index'); 
            ...
            elseif abs(temp_Meron_num+1) == error
                ...
                region_index = temp_ind;
                atom_index = temp_atom_ind;
                save([pwd,'/output_data/BLG_upper_layer_skyrmion_1.mat'],'atomup_sim','displacementUP','region_index','atom_index');
                clear atomup_sim displacementUP region_index atom_index
    ...
    if temp_Meron_num > 0
        ...
        if error < 1
            ...
            if abs(temp_Meron_num-0.5) == error
                ...
                region_index = temp_ind;
                atom_index = temp_atom_ind;
                save([pwd,'/output_data/BLG_upper_layer_anti_meron_1.mat'],'atomup_sim','displacementUP','region_index','atom_index'); 
                clear atomup_sim displacementUP region_index atom_index
            ...
            elseif abs(temp_Meron_num-1) == error
                ...
                region_index = temp_ind;
                atom_index = temp_atom_ind;
                save([pwd,'/output_data/BLG_upper_layer_anti_skyrmion_1.mat'],'atomup_sim','displacementUP','region_index','atom_index'); 
                clear atomup_sim displacementUP region_index atom_index
            end

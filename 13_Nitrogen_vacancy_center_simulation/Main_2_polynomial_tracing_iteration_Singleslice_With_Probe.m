...
FinalVol = importdata([pwd,'/output_data/Rec_With_Probe_NVcenter_Singleslice.mat']);
...
for iter = 1:3
    ...
    MaxIter = 14;       CritIter = 7;       interpol = 3;  Th = 3e-3; 
    Res     = 0.2129/interpol;   minDist  = round(1.4/Res);     
    SearchRadxy = 3;
    SearchRadz  = 3;
    ...
    save([pwd,'/output_data/atom_tracing_NVC_With_Probe_Singleslice_',num2str(iter),'.mat'],'goodAtomTotPos','FinalVol','-v7.3');
    clear FinalVol
end

%% load the auto tracing result 
load('atom_tracing_NVC_With_Probe_Singleslice_1.mat');
atom1 = goodAtomTotPos';
load('atom_tracing_NVC_With_Probe_Singleslice_2.mat');
atom2 = goodAtomTotPos';
load('atom_tracing_NVC_With_Probe_Singleslice_3.mat');
...
save([pwd,'/output_data/atom_tracing_NVC_With_Probe_Singleslice_total.mat'],'atom','-v7.3');
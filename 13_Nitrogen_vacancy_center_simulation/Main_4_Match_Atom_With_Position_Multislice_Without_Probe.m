...
atompos   = importdata('atom_manual_tracing_NVC_Multislice_Without_Probe_Total.mat');
...
atom = atomPos.*res; 
save([pwd,'\output_data\atom_Tracing_NVC_Multislice_Without_Probe_Total.mat'],'atom')
save([pwd,'\output_data\label_Tracing_NVC_Multislice_Without_Probe_Total.mat'],'label')
save([pwd,'\output_data\Projs_Tracing_NVC_Multislice_Without_Probe_Total.mat'],'projs')
save([pwd,'\output_data\angles_Tracing_NVC_Multislice_Without_Probe_Total.mat'],'angles')

...
FinalVol = importdata([pwd,'/output_data/Rec_With_Probe_NVcenter_Multislice.mat']);
...
for iter = 1:3
    ...
    MaxIter = 14;       CritIter = 7;       interpol = 3;  Th = 8e-3; 
    ...
    save([pwd,'/output_data/atom_tracing_NVC_With_Probe_Multislice_',num2str(iter),'.mat'],'goodAtomTotPos','FinalVol','-v7.3');
    clear FinalVol
end

%% load the auto tracing result 
load('atom_tracing_NVC_With_Probe_Multislice_1.mat');
atom1 = goodAtomTotPos';
load('atom_tracing_NVC_With_Probe_Multislice_2.mat');
atom2 = goodAtomTotPos';
load('atom_tracing_NVC_With_Probe_Multislice_3.mat');
...
save([pwd,'/output_data/atom_tracing_NVC_With_Probe_Multislice_total.mat'],'atom','-v7.3');
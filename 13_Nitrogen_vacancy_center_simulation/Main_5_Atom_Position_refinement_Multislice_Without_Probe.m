...
projections = (importdata('Projs_Tracing_NVC_Multislice_Without_Probe_Total.mat'));
angles      = (importdata('angles_Tracing_NVC_Multislice_Without_Probe_Total.mat'));
model       = (importdata('atom_Tracing_NVC_Multislice_Without_Probe_Total.mat'));
model_org   = (importdata('atom_Tracing_NVC_Multislice_Without_Probe_Total.mat'));
atoms       = (importdata('label_Tracing_NVC_Multislice_Without_Probe_Total.mat'));
...
save([pwd,'/output_data/atom_Tracing_NVC_Multislice_Without_Probe_Tracing_Refinement.mat'],'model')
